            ...
            function Edit(data)
            {
               var eurl="edit.php?id={0}&start={2}&end={3}&isallday={4}&title={1}";   
                if(data)
                {
                    ...
                    OpenModelWindow(url,{ width: 600, height: 400, caption:"Редактирование",onclose:function(){
...
//                alert(str);
            ...
            {           
                ...
                hiConfirm("Удалить?", 'Confirm',function(r){ r && callback(0);});
            }
            function wtd(p)
            {
               if (p && p.datestrshow) {
            ...
            $("#faddbtn").click(function(e) {
                var url ="edit.php";
                OpenModelWindow(url,{ width: 500, height: 400, caption: "Создать новый календарь"});
            });
            //go to today
...
<body>
    <div>
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            <div class="cHead"><div class="ftitle"><a href="/cale/sample.php">Календарь </a> | <a href="/cale/cl.php"> Клиенты</a></div>
            ...
            <div class="btnseparator"></div>
             ...
             <div class="btnseparator"></div>
            <div id="sfprevbtn" title="Пред."  class="fbutton">
              <span class="fprev"></span>

            </div>
            <div id="sfnextbtn" title="След." class="fbutton">
